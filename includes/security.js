...
/*
* Use security.encrypt(val, key, bitsize)
* and security.decrypt(val, key, bitsize)
* NeoNexus DeMortis Jan 15, 2009
* neonexus.demortis@gmail.com
*/

Ext.ns('security');
security.encrypt = function(a, b, c){
	if (!(c==128 || c==192 || c==256)) c = 256;
	return AESEncryptCtr(a, b, c);
}
security.decrypt = function(a, b, c){
	if (!(c==128 || c==192 || c==256)) c = 256;
	return AESDecryptCtr(a, b, c);
}
