...
CodePress = {
	...
	syntaxHighlight : function(flag) {
		...
		if(flag != 'init' && window.getSelection() != null) { window.getSelection().getRangeAt(0).insertNode(document.createTextNode(cc));}
		...
		if(flag!='init' && window.getSelection() != null) this.findString();
	},
	
	getLastWord : function() {
		var rangeAndCaret = CodePress.getRangeAndCaret();
		//parent.console.log('Range', rangeAndCaret);
		words = rangeAndCaret[0].substring(rangeAndCaret[1]-40,rangeAndCaret[1]);
		//parent.console.log('Words', words);
	...
	getRangeAndCaret : function() {	
		...
		//parent.console.log('Selection', window.getSelection());
